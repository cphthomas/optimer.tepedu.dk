...
export function kalkulation4() {
  const [a, seta] = useState(+(250).toFixed(2)); //Salgspris incl moms
  const [b, setb] = useState(+(10).toFixed(2)); //avance%
  const [c, setc] = useState(+(10).toFixed(2)); //kapacitetsomkostninger % produktionsomkostninger 
  const [d, setd] = useState(+(20).toFixed(2)); //Afskrivninger DKK
  //const [e, sete] = useState(+(2).toFixed(2)); //Indir forarb omk. i % af var lønomk.
  //const [f, setf] = useState(+(50).toFixed(2)); //var lønomk
  //const [g, setg] = useState(+(50).toFixed(2)); //tillæg indir materiale omk
...
if (problemtype === "Avance i % af egenpris") {
  db=a*.8-a*.8/(1+b/100)
  dbtext1 = "% af de egenprisen"
    ...
    <div>
      ...
      <Container>
        <div class="p-3 mb-2 bg-secondary text-white">
          ...
          <h3>Retrograde fordelingskalkulation</h3>
        </div>
      </Container>
              ...
              <div class="p-3 mb-1 bg-white">
                <Form>
                      <DropdownButton
                        alignleft
                        variant="warning"
                        title={"Retrograde fordelingskalkulation"}
                        size="sm"
                      >
                                   ...
                                   id="type"
                                    ...
                                    onSelect={problemtypeSelect}
                                                >
                                                    ...
                                                    <Dropdown.Item eventKey="Avance i % af egenprisen">
                                                    <small>Avancen beregnes som % af egenprisen</small>
                                                        </Dropdown.Item>
                                                    <Dropdown.Item eventKey="Avance i % af salgspris">
                                                    <small>Avancen beregnes som % af salgsprisen excl. moms</small>
                                                        </Dropdown.Item>
                                                </DropdownButton>
                ...
                <h6>
                Ved fordelingskalkulation beregnes salgspris som variable og faste omkostninger, tillagt avance
                  </h6>
                  ...
                  <InputGroup size="sm">
                    ...
                    <div class="input-group-prepend">
                      ...
                      <OverlayTrigger
                                                        ...
                                                        overlay={
                                                            <Tooltip>
                                                                Egenpris i DKK består af indkøbspris + fragt + øvrige variable omkostninger
                                                            </Tooltip>
                                                        }
                                                    > 
                       <span>Egenpris</span>
      ...
      <Container>
        <div class="p-3 mb-2 bg-secondary text-white">
          {/* <div class="card">
            <div class="p-4"> */}
          <h3>Skema retrograde fordelingskalkulation</h3>
  ...
  <tbody>
    ...
    <tr>
    <td><p class="text-left" >Avance</p></td>
      <td>{b}% · {(problemtype === "Avance i % af egenpris"?numberFormat3(a*0.8-db):numberFormat3(a*0.8))}</td>
      <td><p class="text-right" >{numberFormat3(db)} DKK</p></td>
    </tr>

    <tr class="table-secondary">
    <td><p class="text-left" >Egenpris</p></td>
